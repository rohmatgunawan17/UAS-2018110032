...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="hidden fixed top-0 left-0 px-2 py-2 sm:block">
                <a href="{{ url('/') }}"><img src="img/logo.png" alt="POLRI" style="width: 20%; border-radius: 20%;">
                </a>
            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-outline-primary"><span>Log in</span></a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn btn-outline-primary"><span>Register</span></a>
                        @endif
                    @endauth
                </div>
            @endif
